...
jQuery(document).ready(function($){
	...
	$("#optimizacion").on("click", function(){
		 ...
		 $('#outs').removeClass('boxShadow');
		 $("#service").hide();
	     $('#service').html("<h4>Optimización de procesos de gestión</h4><p>A través de un grupo de ingenieros especializado en la gestión de procesos productivos y organizacionales, desarrollo e implementación de herramientas de control, gestión y simulación, se logra ensayar ideas, validar proyectos y mejorar procesos, fundamentar tomas de decisiones, detección temprana de errores para prevenirlos, reducir sus costos asociados, optimizar recursos, pronosticar resultados, entrenar y capacitar al personal. En un contexto caracterizado por el dinamismo, la complejidad y la tecnología, brindamos las soluciones adecuadas para cada caso.</p><p>&bull; <b>Simulación de procesos a medida</b></p><p>&bull; <b>Organización y gestión de procesos</b></p><p>&bull; <b>Indicadores automáticos de producción</b></p><p>&bull; <b>Software de simulación</b></p><p>&bull; <b>Capacitación y Entrenamiento</b></p>").fadeIn("slow");
